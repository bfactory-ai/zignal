...
pub fn main() !void {
    ...
    var image: Image(Rgb) = try .load(io, allocator, "../assets/liza.jpg");
    ...
    try horizontal_blur.save(io, allocator, "motion_blur_horizontal.png");
    ...
    try vertical_blur.save(io, allocator, "motion_blur_vertical.png");
    ...
    try diagonal_blur.save(io, allocator, "motion_blur_diagonal.png");
    ...
    try zoom_blur.save(io, allocator, "motion_blur_zoom.png");
    ...
    try spin_blur.save(io, allocator, "motion_blur_spin.png");
