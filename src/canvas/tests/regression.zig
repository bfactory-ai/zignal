...
const md5_checksums = [_]DrawTestCase{
    ...
    .{ .name = "drawBezierCubic", .md5sum = "3bedf06af7acd53152e3291bd6efb4ab", .draw_fn = drawBezierCubic },
    .{ .name = "drawBezierQuadratic", .md5sum = "1716e0d85b69aa1d1d2558f9bfc93543", .draw_fn = drawBezierQuadratic },
    .{ .name = "drawPolygonComplex", .md5sum = "b08e07a3f5e8c95da96fef148ebd4b33", .draw_fn = drawPolygonComplex },
    .{ .name = "drawSplinePolygon", .md5sum = "635783272c814a7997f6dc431d3f432a", .draw_fn = drawSplinePolygon },
    ...
    .{ .name = "drawRectangleSoft", .md5sum = "28bcbd2b25b5eb779753e2d45276aaf7", .draw_fn = drawRectangleSoft },
    .{ .name = "fillRectangleSoft", .md5sum = "88b0b952128335c57d2fefebd8902e8e", .draw_fn = fillRectangleSoft },
    .{ .name = "drawPolygonOutline", .md5sum = "bbc76a33185e7de4e52a452a1e429e92", .draw_fn = drawPolygonOutline },
    .{ .name = "fillPolygonFast", .md5sum = "994fbc386a4251c16bea6ac45819519a", .draw_fn = fillPolygonFast },
    .{ .name = "drawCubicBezierFast", .md5sum = "e2ff340fa711b5bc30f08c25596f23b6", .draw_fn = drawCubicBezierFast },
    .{ .name = "drawQuadraticBezierFast", .md5sum = "e77b29489ff085a7d94373fe63e3e38b", .draw_fn = drawQuadraticBezierFast },
