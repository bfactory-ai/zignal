...
const md5_checksums = [_]DrawTestCase{
    ...
    .{ .name = "drawRectangleOutline", .md5sum = "b2e15f669c3debb0c2814552d719c5fe", .draw_fn = drawRectangleOutline },
    ...
    .{ .name = "drawRectangleSoft", .md5sum = "b1a4554723c85e21bd6d1c3c3de9889e", .draw_fn = drawRectangleSoft },
