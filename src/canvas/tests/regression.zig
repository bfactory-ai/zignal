...
const md5_checksums = [_]DrawTestCase{
    ...
    .{ .name = "drawBezierCubic", .md5sum = "5a2bae2e482be60d6735e31d164a252a", .draw_fn = drawBezierCubic },
    .{ .name = "drawBezierQuadratic", .md5sum = "b0c7d23a4515c9400863b7a2a8d7d490", .draw_fn = drawBezierQuadratic },
    .{ .name = "drawPolygonComplex", .md5sum = "b08e07a3f5e8c95da96fef148ebd4b33", .draw_fn = drawPolygonComplex },
    .{ .name = "drawSplinePolygon", .md5sum = "f21b2c2e318eb72c6c1fdead697fae61", .draw_fn = drawSplinePolygon },
    ...
    .{ .name = "drawRectangleSoft", .md5sum = "939952fd49947ffb79d82e9c18dc3bb3", .draw_fn = drawRectangleSoft },
    .{ .name = "fillRectangleSoft", .md5sum = "88b0b952128335c57d2fefebd8902e8e", .draw_fn = fillRectangleSoft },
    .{ .name = "drawPolygonOutline", .md5sum = "5b7bd08c7067300cb139d00b6e1d833f", .draw_fn = drawPolygonOutline },
    ...
    .{ .name = "drawTextOutlineVector", .md5sum = "3e5329f017ff0135fd0a375a213601df", .draw_fn = drawTextOutlineVector },
