...
fn matrix_lu_method(self_obj: ?*c.PyObject, args: ?*c.PyObject) callconv(.c) ?*c.PyObject {
    ...
    const sign_obj = python.convertToPython(lu_result.sign) orelse {
        c.Py_DECREF(l_obj);
        c.Py_DECREF(u_obj);
        c.Py_DECREF(p_list);
        c.Py_DECREF(result_dict);
...
fn matrix_qr_method(self_obj: ?*c.PyObject, args: ?*c.PyObject) callconv(.c) ?*c.PyObject {
    ...
    const rank_obj = python.convertToPython(qr_result.rank) orelse {
        c.Py_DECREF(q_obj);
        c.Py_DECREF(r_obj);
        c.Py_DECREF(result_dict);
        return null;
...
fn matrix_svd_method(self_obj: ?*c.PyObject, args: ?*c.PyObject, kwds: ?*c.PyObject) callconv(.c) ?*c.PyObject {
    ...
    const converged_obj = python.convertToPython(svd_result.converged) orelse {
        c.Py_DECREF(result_dict);
        return null;
    };
